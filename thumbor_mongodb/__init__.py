...
Config.define('MONGO_LOADER_ID_FIELD', '_id', 'MongoDB document field used for search', 'mongo_loader')
Config.define('MONGO_LOADER_DATA_FMT', 'binary', 'MongoDB image format', 'mongo_loader')
